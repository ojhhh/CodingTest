...
// 시간 초과 실패
// let len = callings.length;
// for (let i = 0; i < len; i++) {
//   var tmp = players.indexOf(callings[i]);
//   players[tmp] = players[tmp - 1];
//   players[tmp - 1] = callings[i];
// }
...
//   let ta = players.indexOf(callings[j]);
//   console.log(ta);
//   let tb = players.splice(ta, 1);
//   players.splice(ta - 1, 0, tb[0]);
// }
...
//   let ta = players.indexOf(Object.keys(tmp)[i]);
//   let tb = players.splice(ta, 1);
//   players.splice(ta - Object.values(tmp)[i], 0, tb[0]);
// }
